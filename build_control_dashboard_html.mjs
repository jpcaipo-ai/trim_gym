...
<body>
  ...
  <script>
    ...
    function attributedComboChart(id, rows) {
      ...
      ctx.fillStyle = '#334155'; ctx.font = '11px Segoe UI, Arial'; ctx.textAlign = 'left'; ctx.fillText('1era compra', pad.l + 16, 22);
      ctx.fillStyle = '#c58a00'; ctx.fillRect(pad.l + 132, 12, 11, 11);
      ctx.fillStyle = '#334155'; ctx.fillText('Matrícula Intro', pad.l + 148, 22);
      ctx.fillStyle = '#6b4bb7'; ctx.fillRect(pad.l + 230, 12, 11, 11);
      ctx.fillStyle = '#334155'; ctx.fillText('Ajuste S/900', pad.l + 246, 22);
      if (!monthOnly) {
